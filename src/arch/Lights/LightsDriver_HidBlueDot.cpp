...
LightsDriver_HidBlueDot::LightsDriver_HidBlueDot()
	:
	m_Marquee_UpLeft(&m_iCabData[2], 0x01),
	m_Marquee_UpRight(&m_iCabData[2], 0x02),
	m_Marquee_LwLeft(&m_iCabData[2], 0x04),
	m_Marquee_LwRight(&m_iCabData[2], 0x08),
	m_Buttons_Left(&m_iCabData[2], 0x10),
	m_Buttons_Right(&m_iCabData[2], 0x20),
	m_Bass(&m_iCabData[2], 0x40),
	m_Optional(&m_iCabData[2], 0x80),

	m_PadP1_Up(&m_iPadData[2], 0x01),
	m_PadP1_Down(&m_iPadData[2], 0x02),
	m_PadP1_Left(&m_iPadData[2], 0x04),
	m_PadP1_Right(&m_iPadData[2], 0x08),
	m_PadP2_Up(&m_iPadData[2], 0x10),
	m_PadP2_Down(&m_iPadData[2], 0x20),
	m_PadP2_Left(&m_iPadData[2], 0x40),
	m_PadP2_Right(&m_iPadData[2], 0x80)
{
	m_iCabData[1] = 0x01;
	m_iPadData[1] = 0x02;
